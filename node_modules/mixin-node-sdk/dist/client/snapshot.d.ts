...
export declare class SnapshotClient implements SnapshotClientRequest {
...
export declare const readSnapshots: (token: string, params: SnapshotQuery) => Promise<Snapshot[]>;
export declare const readSnapshot: (token: string, snapshot_id: string) => Promise<Snapshot>;
