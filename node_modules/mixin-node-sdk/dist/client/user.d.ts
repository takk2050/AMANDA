...
export declare class UserClient implements UserClientRequest {
...
export declare const userMe: (token: string) => Promise<User>;
export declare const readFriends: (token: string) => Promise<User[]>;
export declare const readBlockUsers: (token: string) => Promise<User[]>;
