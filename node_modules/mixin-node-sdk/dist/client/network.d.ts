...
export declare const readExternalTransactions: (params: SnapshotQuery) => Promise<Transaction[]>;
export declare const readNetworkAssetsTop: () => Promise<Asset[]>;
...
export declare const readNetworkTicker: (asset_id: string, offset?: string | undefined) => Promise<NetworkTicker>;
export declare const sendExternalProxy: (method: string, params: any[]) => Promise<any>;
