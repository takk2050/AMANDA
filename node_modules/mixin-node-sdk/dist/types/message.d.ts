...
export declare type MessageCategory = 'ENCRYPTED_TEXT' | 'ENCRYPTED_AUDIO' | 'ENCRYPTED_POST' | 'ENCRYPTED_IMAGE' | 'ENCRYPTED_DATA' | 'ENCRYPTED_STICKER' | 'ENCRYPTED_LIVE' | 'ENCRYPTED_LOCATION' | 'ENCRYPTED_VIDEO' | 'ENCRYPTED_CONTACT' | 'PLAIN_TEXT' | 'PLAIN_AUDIO' | 'PLAIN_POST' | 'PLAIN_IMAGE' | 'PLAIN_DATA' | 'PLAIN_STICKER' | 'PLAIN_LIVE' | 'PLAIN_LOCATION' | 'PLAIN_VIDEO' | 'PLAIN_CONTACT' | 'APP_CARD' | 'APP_BUTTON_GROUP' | 'MESSAGE_RECALL' | 'SYSTEM_CONVERSATION' | 'SYSTEM_ACCOUNT_SNAPSHOT';
