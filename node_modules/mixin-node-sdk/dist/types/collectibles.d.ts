...
export declare type CollectibleOutputState = 'unspent' | 'signed' | 'spent';
export declare type CollectibleAction = 'sign' | 'unlock';
export declare type CollectibleRequestState = 'initial' | 'signed';
