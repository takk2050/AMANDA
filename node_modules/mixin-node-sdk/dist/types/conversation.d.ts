...
export declare type ConversationCategory = 'CONTACT' | 'GROUP';
export declare type ConversationAction = 'CREATE' | 'ADD' | 'REMOVE' | 'JOIN' | 'EXIT' | 'ROLE';
export declare type ConversationRole = 'OWNER' | 'ADMIN' | '';
